...
(function (exports) {
    ...
    function isARMode() {
        return (
            isWithinToolboxApp() && !isDesktop() && realityEditor.device.modeTransition.isARMode()
        );
    }
    ...
    exports.isObjectRenderingSuppressed = () => {
        return (
            Object.keys(suppressedRenderingFlags).length > 0 || variables.suppressObjectRendering
        );
    };
