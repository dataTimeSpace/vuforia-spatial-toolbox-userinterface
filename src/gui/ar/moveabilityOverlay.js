...
realityEditor.gui.ar.moveabilityOverlay.drawBox = function (svg, svgNS, x, y) {
    ...
    this.drawMultiLine(
        svg,
        svgNS,
        x / 200 + ',' + x / 5 + ',' + x / 200 + ',' + x / 200 + ',' + x / 5 + ',' + x / 200,
        20,
        x,
        y
    );
...
realityEditor.gui.ar.moveabilityOverlay.drawMultiLine = function (
    svg,
    svgNS,
    points,
    width,
