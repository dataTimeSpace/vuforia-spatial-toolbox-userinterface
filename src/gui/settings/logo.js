...
realityEditor.gui.settings.logo.logoSize = {
    W: (1785 / 2) * 1.5,
    H: 1035 * 1.5,
    offsetX: 100,
    offsetY: 60,
...
realityEditor.gui.settings.logo.thePoint = [
    { p1: [936, 144], l1: 118 },
    { p1: [1658, 131], l1: 114 },
    { p1: [111, 780], l1: 101 },
...
realityEditor.gui.settings.logo.text = [
    { p1: [160, 533], l1: 210 },
    { p1: [178, 622], l1: 68 },
    { p1: [178, 160], l1: 68 },
];
...
realityEditor.gui.settings.logo.logoResize = function () {
    for (var i1 = 0; i1 < this.line.length; i1++) {
        this.line[i1] = {
            p1: [
                this.logoSize.offsetX +
                    realityEditor.gui.ar.utilities.map(
                        this.line[i1].p1[0],
                        0,
                        1785,
                        0,
                ...
                this.logoSize.offsetY +
                    realityEditor.gui.ar.utilities.map(
                        this.line[i1].p1[1],
                        0,
                        1035,
                        0,
                        (1035 / 1785) * this.logoSize.W
                    ),
            ],
    ...
    for (i1 = 0; i1 < this.thePoint.length; i1++) {
        this.thePoint[i1] = {
            ...
            l1: realityEditor.gui.ar.utilities.map(
                this.thePoint[i1].l1,
                0,
                1785,
                0,
