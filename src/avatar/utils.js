...
(function (exports) {
    ...
    exports.getColor = function (avatarObject) {
        if (!this.isAvatarObject(avatarObject)) {
            return null;
        }
    ...
    exports.getAvatarName = function () {
        ...
        const deviceSuffix = realityEditor.device.environment.variables.supportsAreaTargetCapture
            ? '_iOS'
            : '_desktop';
    ...
    exports.getAvatarNodeInfo = function (avatarObject) {
        ...
        let avatarNodeKey = Object.keys(myAvatarTool.nodes).find((name) =>
            name.includes(this.NODE_NAME)
        );
        if (!avatarNodeKey) {
            return null;
        }
